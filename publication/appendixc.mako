...
flow="flow --tolerance-cnv=${cnv} --tolerance-cnv-relaxed=${cnv_relaxed} --newton-min-iterations=1 --solver-max-restarts=20 --time-step-control=newtoniterationcount --solver-growth-factor=1.6 --linear-solver=cpr_trueimpes --time-step-control-growth-rate=1.1 --solver-restart-factor=0.5 --time-step-control-decay-rate=0.65 --enable-opm-rst-file=true"
...
inj=[[8100, 8100, 3E-7, 0], 
[10200, 10200, 3E-7, 3E-7], 
[68100, 68100, 0, 0], 
[345600, 86400, 0, 0]]
...
facie5={"permx5"=2120000,"permz5"=2120000,"poro5"=0.39,"disperc5"=0,"swi5"=0.23,"sni5"=0.01,"pen5"=170,"nkrw5"=2,"nkrn5"=2,"npe5"=2,"thre5"=5e-2,"npnt5"=100}
...
max_function_evaluations = 64 # Maximum number of simulations
rng = ${rng} # Set a specific seed for reproducibility; a value of 0 means no seed (rng for everest and random_seed for ert)
cores = ${cores} # Maximum number of simulations running in parallel
maxtime = 7200 # Maximum runtime in seconds of a realization; a value of 0 means unlimited runtime
delete = false # Delete large files?
monotonic = true # Only consider monotonic values, e.g, increasing entry pressure with decreasing sand size
