#!/usr/bin/env python3
# Modified from
# https://github.com/fluidflower/general/blob/main/evaluation/emd.py
...
def emd():
    ...
    parser.add_argument(
        "-in1", "--infilename1", help="The file name of the first image."
    )
    parser.add_argument(
        "-in2", "--infilename2", help="The file name of the second image."
    )
